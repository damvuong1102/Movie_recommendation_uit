      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between gap-4 py-2">
          ...
          >
            ...
            /> */}
          {/* <h1 
              className="text-2xl sm:text-3xl font-black text-[#E50914] uppercase origin-left inline-block"
              style={{ 
...
<h1 
    className="text-2xl sm:text-3xl font-black text-[#E50914] origin-left inline-block"
    style={{ 
      fontFamily: "'Bebas Neue', 'Impact', sans-serif",
  ...
  >
    Phim
    {/* Chữ "Đúng" đổi màu theo giao diện Sáng/Tối */}
    <span className="text-black dark:text-white transition-colors duration-200 mx-1">
      Đúng
    </span>
    Gu
  </h1>
