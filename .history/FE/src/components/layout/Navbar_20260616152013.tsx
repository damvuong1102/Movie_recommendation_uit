        ...
        <div className="flex items-center justify-between gap-4 py-2">
          ...
          <h1 
              ...
              style={{ 
                ...
                textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)', // Giảm độ đậm của shadow để hợp với cả nền sáng
                transform: 'scaleX(0.8)', 
                letterSpacing: '0.12em' 
              }}
            >
              Movies
              <span className="text-black dark:text-white transition-colors duration-200">4
              </span>
              You
            </h1>
          </Link>
