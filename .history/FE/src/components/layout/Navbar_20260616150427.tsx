...
<h1 
    ...
    style={{ 
      ...
      transform: 'scaleX(0.8)', // Thu hẹp độ rộng chữ còn 80%
      letterSpacing: '-0.05em'   // Ép các chữ dính sát nhau hơn nữa
    }}
  >
    Movies<span className="text-white dark:text-white">4</span>You
  </h1>
          </Link>
