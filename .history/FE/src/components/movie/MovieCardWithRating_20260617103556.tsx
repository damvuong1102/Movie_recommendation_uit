...
// Bảng cấu hình dịch tên thể loại từ Anh sang Việt
    ...
    >
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Khối xử lý đánh giá 5 ngôi sao:
            Sử dụng e.stopPropagation() cực kỳ quan trọng ở đây nhằm mục đích chặn bọt sự kiện (Chống tràn click). 
            Giúp người dùng khi bấm chọn sao để chấm điểm thì trình duyệt không kích hoạt nhầm lệnh click của thẻ cha Card (tránh việc tự động nhảy trang sang /movie/:id)
          */}
          <div
          ...
          >
            {isSubmitting ? (
              // Icon quay vòng biểu thị hệ thống đang xử lý lưu điểm số lên database
              <Loader2 className="w-4 h-4 animate-spin text-muted-foreground" />
            ) : (
              // Vòng lặp vẽ ra 5 ngôi sao tương tác
              [1, 2, 3, 4, 5].map((star) => (
                <Star
                  key={star}
